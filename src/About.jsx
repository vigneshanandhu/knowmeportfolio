    ...
    <div className='container'>
      ...
      <div className="row align-items-center mt-5">
        <div className="col-12 col-md-6">
          <img src={AboutImg} alt="" className='img-fluid w-75 w-md-25 rounded d-block mx-auto ' />
        </div>
        <div className="col-12 col-md-6">
        ...
        <div className="col-12 mb-5 d-md-flex gap-5 justify-content-center mt-5 align-items-start">
